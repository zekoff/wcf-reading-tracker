...
export function ReadingView({
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-4 py-8">
      ...
      <div>
        <h1 className="text-lg font-semibold text-gray-900">{section.chapterTitle}</h1>
        <p className="mt-4 whitespace-pre-wrap text-base leading-7 text-gray-800">
          {section.text}
        </p>
      </div>

      {section.footnotes && section.footnotes.length > 0 && (
        <details className="rounded-md border border-gray-200 p-3 text-sm text-gray-600">
